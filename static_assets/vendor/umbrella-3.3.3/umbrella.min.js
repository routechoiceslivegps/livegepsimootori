...
/* Customisation */
u.prototype.prop=(name,value)=>{if(value===undefined){return this.first()[name]}this.each((node)=>{node[name]=value});return this};u.prototype.val=(value)=>{return this.prop("value",value)};u.prototype.appendTo=(target)=>{u(target).append(this);return this};u.prototype.css=(styleProps)=>{this.each((node)=>{Object.assign(node.style,styleProps)});return this};u.prototype.hide=()=>{return this.css({display:"none"});};u.prototype.show=()=>{return this.css({display:"block"})};
